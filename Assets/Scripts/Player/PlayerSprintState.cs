       ...
       if (animator.gameObject.GetComponent<CharacterController>() != null && animator.gameObject.GetComponent<PlayerController>() != null)
        {
            ...
            characterController.Move(Direction * Time.deltaTime * playerController.sprintSpeed);
            ...
            // characterController.Move(new Vector3(playerController.movement.ReadValue<Vector2>().x, 0, playerController.movement.ReadValue<Vector2>().y) * Time.deltaTime * playerController.sprintSpeed);
        }
    }
